export const citiesDb = {
  ...
  KW: ['Kuwait City', "Al Jahra'", 'Abu Hulayfah', 'Al Ahmadi', 'Ar Riqqah'],
  HU: [
    'Budapest',
    'Debrecen',
    'Szekesfehervar',
  ...
  DJ: ['Djibouti', 'Arta', 'Ali Sabieh', 'Dikhil', 'Obock', 'Yoboki', 'Tadjourah'],
  TN: [
    'Tunis',
    'Sidi Bouzid',
    'Sfax',
  ...
  BS: ['Nassau', 'Lucaya', 'Freeport City', 'West End'],
  MQ: ['Fort-de-France'],
  GP: ['Pointe-a-Pitre', 'Basse-Terre'],
  BW: [
    'Gaborone',
    'Francistown',
    'Molepolole',
  ...
  NC: ['Noumea', 'Dumbea', 'Mont-Dore', 'Paita', 'Kone', 'We'],
  ME: [
    'Podgorica',
    'Niksic',
    'Ulcinj',
  ...
  SB: ['Honiara', 'Auki', 'Gizo', 'Kirakira', 'Buala', 'Tulagi', 'Tigoa', 'Lata', 'Taro'],
  YT: [
    'Mamoudzou',
    'Koungou',
    'Dembeni',
  ...
  LC: ['Castries', 'Gros Islet', 'Micoud', 'Vieux Fort', 'Bisee'],
  ST: [
    'Sao Tome',
    'Santana',
    'Neves',
  ...
  BN: ['Bandar Seri Begawan', 'Seria', 'Kampong Tunah Jambu', 'Kuala Belait', 'Bangar', 'Tutong'],
  VU: ['Port-Vila', 'Luganville', 'Isangel', 'Lakatoro', 'Sola', 'Saratamata'],
  WS: [
    'Apia',
    'Afega',
    'Safotu',
  ...
  DM: ['Roseau'],
  FM: ['Weno', 'Palikir', 'Kolonia', 'Colonia', 'Tofol'],
  FO: [
    'Torshavn',
    'Klaksvik',
    'Hvalba',
  ...
  VG: ['Road Town'],
  AS: ['Pago Pago'],
  GD: ["Saint David's", "Saint George's"],
  SM: [
    'Serravalle',
    'Borgo Maggiore',
    'San Marino',
  ...
  VA: ['Vatican City'],
  NR: ['Yaren'],
  SH: ['Jamestown', 'Edinburgh of the Seven Seas', 'Georgetown'],
  NU: ['Alofi'],
  MS: ['Brades', 'Plymouth'],
  NF: ['Kingston'],
  GS: ['Grytviken', 'King Edward Point'],
  PN: ['Adamstown'],
  VI: ['Charlotte Amalie'],
  AX: [
    'Mariehamn',
